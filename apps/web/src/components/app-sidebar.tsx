...
const navTeacher = [
  ...
  { title: "Bank Soal", url: "/teacher/library", icon: <HugeiconsIcon icon={Quiz02Icon} strokeWidth={2} />, items: [{ title: "Perpustakaan Soal", url: "/teacher/library" }, { title: "Daftar Soal", url: "/teacher/quizzes" }] },
