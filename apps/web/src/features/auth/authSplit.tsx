    ...
    <div className="flex h-screen bg-white text-neutral-900 font-sans overflow-hidden">
      <div className="w-full lg:w-120 h-full overflow-y-auto">
        <div className="mx-auto flex min-h-full flex-col px-6 py-10 sm:px-8">
          ...
          <main className="flex flex-1 flex-col justify-center items-center lg:items-start">
            <h1 className="w-full max-w-md text-center lg:text-left text-2xl font-semibold tracking-tight text-neutral-900">{title}</h1>
            {subtitle ? (
              <p className="mt-1 w-full max-w-md text-center lg:text-left text-sm text-neutral-500">{subtitle}</p>
            ) : null}
